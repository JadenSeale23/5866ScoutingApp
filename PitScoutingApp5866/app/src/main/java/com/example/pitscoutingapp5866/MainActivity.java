package com.example.pitscoutingapp5866;
...
public class MainActivity extends AppCompatActivity {
    ...
    EditText teamNum, teamName, varA, varB, varC, varD, notes;
    CheckBox  varE;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        varC = (EditText) findViewById(R.id.varcin);
        varD = (EditText) findViewById(R.id.vardin);
            ...
            public void onClick(View view) {
                {
                    ...
                    try {
                        in = "Team num: " + teamNum.getText().toString() +
                                ...
                                "\nRobot Weight: " + varA.getText().toString() +
                                "\nBiggest Achievements: " + varB.getText().toString() +
                                "\nBiggest Struggles: " + varC.getText().toString() +
                                "\nVeterans: " + varD.getText().toString() +
                                "\nAdjustable Hang: " + varE.isChecked() + "" +
                                "\nObservations: " + notes.getText().toString();
